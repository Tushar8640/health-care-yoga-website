...
const Footer = () => {
  return (
    <footer className="bg-gray-700">
      <div className=" container shadow-lg mb-2 text-center md:text-left mx-auto grid grid-cols-1 md:grid-cols-4 px-3 py-5">
        <div>
          ...
          <div className="flex  mb-8 space-x-6 mt-3 md:justify-start justify-center md:mb-0">
     ...
     {/* under footer  */}
              ...
              <div className="mt-8 md:mt-0 md:order-1 py-5 text-center">
                <span className="mt-2 text-sm font-light text-gray-300"> Copyright © 2020 - 2021  @ Tushar Imran  . Since 2020 </span>
              </div>
